  ...
  return (
    <div className="text-lg text-center relative isolate px-6 py-24 lg:px-8" id="contact">
      <div className="mt-10 flex items-center justify-center gap-x-4">
        ...
        <a href="https://github.com/sheiklAR" target="_blank" rel="noreferrer">
        <button className="btn btn-outline btn-square">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-8 w-8"
        ...
        <a href="mailto:sheikabdulrahman2000@gmail.com">
        <button className="btn btn-outline btn-square">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-8 w-8"
      ...
      <p className="text-sm">Copyright © 2023 React Portfolio. All Rights Reserved</p>
    </div>
  );
}
